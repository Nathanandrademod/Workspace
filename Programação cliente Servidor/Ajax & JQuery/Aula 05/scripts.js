	...
	$.ajax({
		...
		.done(function (result) {
			...
			$.map(result, function (val, i) {
				table += '<tr>' + '<td>' + val.id + '</td>' + '<td class="col_fabricante">' + val.fabricante +
				 '</td>' + '<td class="col_modelo">' + val.modelo + '</td>' + '<td class="col_ano">' + val.ano + '</td>' +
				  '<td>' + val.cor + '</td>' + '<td>' + val.valor + '</td>' + '</tr>';
			});
			table += "</table>"
			$("#resultado").html("");
